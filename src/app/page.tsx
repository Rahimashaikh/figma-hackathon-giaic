...
import FeaturesPosts from '@/components/shop-components/featuresposts';
...
const Topline = () => {
  return (
    <div className="w-full md:block min-h-screen  flex flex-col">
      {/* Topline */}
      <div
        className={`w-full h-[58px]  bg-[#252B42] flex justify-between items-center px-4 ${montserrat.className}`}
      >
        <div className="flex md:bock  gap-4 text-white">
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <button className="flex items-center gap-2 text-[rgb(35,166,240)]">
      ...
      <nav className="md:hidden">
            <Sheet>
              ...
              <SheetContent className="bg-cyan-100">
                <SheetHeader>
                  <SheetTitle className=" bg-slate-100 font-bold text-black italic text-4xl">
                    Bandage
                  </SheetTitle>
                  <SheetDescription className="flex flex-col gap-4">
                  <Link href="/" className="text-sm top-3 hover:text-gray-600 font-bold">
            Home
          </Link>
          <Link href="/shop" className="text-sm font-bold hover:text-gray-600 flex items-center gap-1">
            Shop <RiArrowDropDownLine className="text-lg" />
