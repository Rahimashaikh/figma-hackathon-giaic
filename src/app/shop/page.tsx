...
<div className="flex grid-cols-1 sm:grid-cols-3 w-full justify-center mt-28  gap-[15px]">
  <Image src="/images/22.png" width={205} height={223} alt="arrow" />
  <Image src="/images/23.jpg" width={205} height={223} alt="arrow" />
  <Image src="/images/24.png" width={205} height={223} alt="arrow" />
  <Image src="/images/25.png" width={205} height={223} alt="arrow" />
  <Image src="/images/26.png" width={205} height={223} alt="arrow" />
</div>
 </div>         
</div> 
